...
RUN java -jar /usr/share/jenkins/jenkins-plugin-manager-0.1-alpha-12-SNAPSHOT.jar --war /usr/share/jenkins/jenkins.war --plugin-file /usr/share/jenkins/ref/plugins.txt -d /usr/share/jenkins/ref/plugins
